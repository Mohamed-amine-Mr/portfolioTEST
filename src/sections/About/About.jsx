              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600 dark:text-gray-300">
                    ...
                    avec React.js et Next.js
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300">
                    Expertise en state management avec Redux, Redux Toolkit, et
                    React Query
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300">
                    Solutions e-commerce modernes avec WordPress, Shopify, et
                    WooCommerce
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300">
                    Performance optimisée grâce à des techniques comme memo,
                    useMemo, et code splitting
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300">
                    Interfaces intuitives et attrayantes avec Tailwind CSS, CSS
                    Modules, et Styled Components
                  </span>
                </li>
              </ul>
            </motion.div>
