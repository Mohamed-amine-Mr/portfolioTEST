...
//                 <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-purple-300/20 z-10"></div>
//                 <canvas
//                   ref={canvasRef}
...
const About = () => {
  ...
  // Detailed skills from Competences.jsx
  ...
  return (
    <section
      id="about"
      className="py-24 px-6 lg:px-16 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/30 dark:to-purple-900/30 "
    >
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-16">
