        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <div className="relative mx-auto lg:mx-0 mb-8">
              <div className="absolute -inset-1 bg-gradient-to-r from-primary-light to-secondary-light dark:from-primary-dark dark:to-secondary-dark rounded-xl blur opacity-75"></div>
              <div className="absolute -inset-4 bg-gradient-to-r from-primary-light to-secondary-light dark:from-primary-dark dark:to-secondary-dark rounded-xl blur-lg opacity-20"></div>
              <div className="relative rounded-xl overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl aspect-[4/5] w-full max-w-md">
                <div className="absolute inset-0 bg-gradient-to-tr from-primary-light/20 to-secondary-light/20 dark:from-primary-dark/20 dark:to-secondary-dark/20 z-10"></div>
                <img
                  src={img}
                  srcSet={`${imgSmall} 300w, ${imgLarge} 600w`}
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          أستخدم React.js و Next.js مع أدوات مثل Redux و React
                          Router لتطوير تطبيقات ويب متطورة وسريعة.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          أصمم واجهات مستخدم جذابة باستخدام Tailwind CSS و
                          Styled Components لضمان تجربة مستخدم مثالية.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-text-light dark:text-text-dark">
                          مواقع WordPress مخصصة
                        </h4>
                        <p className="text-gray-600 dark:text-gray-300">
                          أقدم حلول WordPress مخصصة لإنشاء مواقع سريعة وسهلة
                          الإدارة تلبي احتياجاتك.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          أحسن أداء المواقع باستخدام تقنيات مثل memo، useMemo، و
                          code splitting لضمان سرعة التحميل.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          أوفر دعما مستمرا وصيانة مجانية لمدة شهرين بعد التسليم
                          لضمان نجاح مشروعك.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="p-4 bg-white dark:bg-gray-800 rounded-full shadow-md">
                        <Layout className="w-8 h-8 text-primary-light dark:text-primary-dark" />
                      </div>
                      <p className="mt-2 text-sm text-center text-gray-600 dark:text-gray-300">
                        WordPress
                      </p>
